...
N=sz(1);
[r,c,p]=size(img);
%filterResponse=cell(1,N);% depending on number of images passed
% for now, since we are passing one image and applying 20 filters on it,
% our response will have 20 rows
filterResponses=[];
lab=rgb2lab(img);
